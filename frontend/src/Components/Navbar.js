      ...
      <div className="navbar-inner">
        ...
        <form className="navbar-search" onSubmit={handleSearch}>
          ...
          <input
            ...
            placeholder="Search dishes, meals or food..."
        ...
        <nav className={`menu-links ${isOpen ? "active" : ""}`}>
          <div className="mobile-menu-head">
            <span>Food App</span>
            <button type="button" onClick={closeMenu} aria-label="Close menu"><CloseIcon /></button>
          </div>
          ...
          <div className="mobile-delivery-location delivery-location">
            <LocationOnOutlinedIcon />
            <div>
              <span>DELIVER TO</span>
              <strong>Choose your location</strong>
          ...
          {user ? (
            <div className="mobile-account-actions">
              <button type="button" onClick={() => { closeMenu(); navigate("/profile"); }}>
                <PersonOutlineIcon /> My Account
              </button>
              <button type="button" onClick={handleLogout}>Sign Out</button>
            </div>
          ) : (
            <button type="button" className="mobile-login" onClick={() => { closeMenu(); navigate("/login"); }}>
              Sign In
            </button>
          )}
        </nav>
        ...
        <div className="navbar-actions">
          <Link to="/cart" className="nav-icon-button cart-link" aria-label="Shopping cart" onClick={closeMenu}>
            <ShoppingCartIcon />
          </Link>
          ...
          <button
            type="button"
            className="nav-icon-button mode-toggle"
        ...
        <button type="button" className="toggle-button" onClick={() => setIsOpen((previous) => !previous)} aria-label="Open navigation menu" aria-expanded={isOpen}>
