        ...
        <aside className="cartSummary">
          {deliveryType === "delivery" && deliveryFee > 0 && (
            <div className="deliveryProgress">
              <div><strong>₹{Math.max(40 - discountedSubtotal, 0).toFixed(2)}</strong> away from FREE delivery</div>
              <div className="deliveryProgressBar"><span style={{ width: `${Math.min((discountedSubtotal / 40) * 100, 100)}%` }} /></div>
            </div>
          )}
          <div className="summaryHeader"><h2>Order Summary</h2></div>
